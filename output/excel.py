...
from model.fitness_functions import DebsTestFunction2, DebsTestFunction4
...
def write_population_stats(population: Population, param_names, run_i, gen_i, homogeneous_frac=None):
    ...
    for i, geno in enumerate(genotypes.keys()):
        ...
        if isinstance(population.fitness_function, DebsTestFunction2) or isinstance(population.fitness_function, DebsTestFunction4):
